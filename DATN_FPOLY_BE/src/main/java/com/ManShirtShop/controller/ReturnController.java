...
public class ReturnController {
    ...
    @Autowired
    private ReturnServiceClient returnServiceClient;
...
//    @PostMapping(value = "/updateSuccess/{returnId}")
//    @ApiResponse(responseCode = "200")
//    public ResponseEntity<ApiResponseCustom<String>> updateSuccesssss(@PathVariable Integer returnId) {
//        try {
...
//    }
    ...
    @Operation(summary = "Cập nhật trạng thái HUỶ ĐƠN cho Return")
