...
public class StatisticController {
    ...
    @PostMapping(value = "countProductAndOrder")
    ...
    @PostMapping(value = "countOrderByMonth")
    public ResponseEntity<List<CountOrderResponse>> countOrderByMonth(@RequestParam Integer year) {
        return ResponseEntity.ok().body(statisticService.countOrderByMonth(year));
    }
    @PostMapping(value = "getOrderReturnByCode")
    public ResponseEntity<OrderReturnDetailResponse> getOrderReturnByCode(@RequestParam String code) {
        return ResponseEntity.ok().body(statisticService.getByCode(code));
    }
}
